...
if ( ! class_exists( 'c2c_RestrictUsernames_Plugin_042' ) ) :

abstract class c2c_RestrictUsernames_Plugin_042 {
	 ...
	 * @since 036
	 */
	public function __clone() { _doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'restrict-usernames' ), '036' ); }
	 ...
	 * @since 036
	 */
	public function __wakeup() { _doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'restrict-usernames' ), '036' ); }
